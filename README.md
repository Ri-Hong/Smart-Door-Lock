...
which is the combination of their id and pin. To unlock the door, the user enters the same code again. When the door locks/unlocks, the servo arm is turned 180 degrees. It can be attatched to a bolt to lock the door. To change the name and pin, the user must use the companion app to do so. 
